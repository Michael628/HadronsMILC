...
def build_params(**module_templates):
    ...
    schedule_file=f"schedules/lma_{env['SERIES']}{env['CFG']}.sched"
            ...
            for gamma_label, gamma_string in gammas_iter:
                ...
                for solver_label in ["ranLL","ama"]:
                    ...
                    for mass2_index, m2 in enumerate(masses):
                        ...
                        if diagonal_masses == True and mass2_index != mass1_index:
                            continue
                        ...
                        quark_m2=f"quark_{solver_label}_pion_local_{mass_label}_{block_label}"
